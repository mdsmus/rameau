...
(define-test pop2cifra
  ...
  (assert-equal '((c "maj" 0) ((c "maj" 0 "7") (m! "bes"))) (pop2cifra 'c--7))
...
(define-test acorde->cifra
  ...
  (assert-equal "G" (acorde->cifra '("g" maj)))
  (assert-equal "G" (acorde->cifra '("g" maj 0)))
  (assert-equal "G/B" (acorde->cifra '("g" maj 1)))
  (assert-equal "G/D" (acorde->cifra '("g" maj 2)))
  (assert-equal "G7m" (acorde->cifra '("g" maj "7m")))
  (assert-equal "G7m" (acorde->cifra '("g" maj 0 "7m")))
  (assert-equal "G7m/B" (acorde->cifra '("g" maj 1 "7m")))
  (assert-equal "G7m/D" (acorde->cifra '("g" maj 2 "7m")))
  (assert-equal "G7m/F#" (acorde->cifra '("g" maj 3 "7m")))
  (assert-equal "G7" (acorde->cifra '("g" maj "7")))
  (assert-equal "G7" (acorde->cifra '("g" maj 0 "7")))
  (assert-equal "G7/B" (acorde->cifra '("g" maj 1 "7")))
  (assert-equal "G7/D" (acorde->cifra '("g" maj 2 "7")))
  (assert-equal "G7/F" (acorde->cifra '("g" maj 3 "7")))
  (assert-equal "Gm" (acorde->cifra '("g" min)))
  (assert-equal "Gm" (acorde->cifra '("g" min 0)))
  (assert-equal "Gm/Bb" (acorde->cifra '("g" min 1)))
  (assert-equal "Gm/D" (acorde->cifra '("g" min 2)))
  (assert-equal "Gm7m" (acorde->cifra '("g" min "7m")))
  (assert-equal "Gm7m" (acorde->cifra '("g" min 0 "7m")))
  (assert-equal "Gm7m/Bb" (acorde->cifra '("g" min 1 "7m")))
  (assert-equal "Gm7m/D" (acorde->cifra '("g" min 2 "7m")))
  (assert-equal "Gm7m/F#" (acorde->cifra '("g" min 3 "7m")))
  (assert-equal "Gm7" (acorde->cifra '("g" min "7")))
  (assert-equal "Gm7" (acorde->cifra '("g" min 0 "7")))
  (assert-equal "Gm7/Bb" (acorde->cifra '("g" min 1 "7")))
  (assert-equal "Gm7/D" (acorde->cifra '("g" min 2 "7")))
  (assert-equal "Gm7/F" (acorde->cifra '("g" min 3 "7")))
  (assert-equal "G+" (acorde->cifra '("g" aug)))
  (assert-equal "G+" (acorde->cifra '("g" aug 0)))
  (assert-equal "G+/B" (acorde->cifra '("g" aug 1)))
  (assert-equal "G+/D#" (acorde->cifra '("g" aug 2)))
  (assert-equal "G+7m" (acorde->cifra '("g" aug "7m")))
  (assert-equal "G+7m" (acorde->cifra '("g" aug 0 "7m")))
  (assert-equal "G+7m/B" (acorde->cifra '("g" aug 1 "7m")))
  (assert-equal "G+7m/D#" (acorde->cifra '("g" aug 2 "7m")))
  (assert-equal "G+7m/F#" (acorde->cifra '("g" aug 3 "7m")))
  (assert-equal "G+7" (acorde->cifra '("g" aug "7")))
  (assert-equal "G+7" (acorde->cifra '("g" aug 0 "7")))
  (assert-equal "G+7/B" (acorde->cifra '("g" aug 1 "7")))
  (assert-equal "G+7/D#" (acorde->cifra '("g" aug 2 "7")))
  (assert-equal "G+7/F" (acorde->cifra '("g" aug 3 "7")))
  (assert-equal "G°" (acorde->cifra '("g" dim)))
  (assert-equal "G°" (acorde->cifra '("g" dim 0)))
  (assert-equal "G°/Bb" (acorde->cifra '("g" dim 1)))
  (assert-equal "G°/Db" (acorde->cifra '("g" dim 2)))
  (assert-equal "G°7" (acorde->cifra '("g" dim "7d")))
  (assert-equal "G°7" (acorde->cifra '("g" dim 0 "7d")))
  (assert-equal "G°7/Bb" (acorde->cifra '("g" dim 1 "7d")))
  (assert-equal "G°7/Db" (acorde->cifra '("g" dim 2 "7d")))
  (assert-equal "G°7/Fb" (acorde->cifra '("g" dim 3 "7d")))
  (assert-equal "Gø7" (acorde->cifra '("g" dim "7")))
  (assert-equal "Gø7" (acorde->cifra '("g" dim 0 "7")))
  (assert-equal "Gø7/Bb" (acorde->cifra '("g" dim 1 "7")))
  (assert-equal "Gø7/Db" (acorde->cifra '("g" dim 2 "7")))
  (assert-equal "Gø7/F" (acorde->cifra '("g" dim 3 "7"))))
