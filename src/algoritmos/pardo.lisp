...
(register-algorithm "Pardo-Birmingham" #'gera-gabarito-pardo #'compara-gabarito-tonal)
...
(register-algorithm "incf-PB" #'gera-gabarito-incf-pardo #'compara-gabarito-tonal)
